...
public class excelReadWrite {
	String xData[][];
	int xRows, xCols;
	String xPath = "D:\\EclipseProjects\\GuruBank\\LoginData.xls";
	String xPathRes = "D:\\EclipseProjects\\GuruBank\\LoginData-Res.xls";
	String xSheet = "Login";
	
	@Test
	public void mainTest() throws Exception{
		String sUrl, sUsername, sPassword, vResult, vError;
