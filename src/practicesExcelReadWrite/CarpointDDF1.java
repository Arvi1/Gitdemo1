				...
				try {
					...
					//try {
						/*for (int c1 = 1; c1 < 6; c1++){			
							String sCarDetails = driver.findElement(By.xpath(s1+c1+s2)).getText();
							System.out.println("Car Details :" + sCarDetails);	
							xData[i][11] = sCarDetails;
							String sCarPrice = driver.findElement(By.xpath(sp1+c1+sp2)).getText();
							System.out.println("Car Price Details :" + sCarPrice);
							xData[i][12] = sCarPrice;
							JavascriptExecutor jse = (JavascriptExecutor)driver;
							jse.executeScript("window.scrollBy(0,100)", "");
							Thread.sleep(2000);	
							}*/	
						/*for (int c2 = 7; c2 < 9; c2++){			
							String sCarDetails = driver.findElement(By.xpath(s1+c2+s2)).getText();
							System.out.println("Car Details :" + sCarDetails);			
							String sCarPrice = driver.findElement(By.xpath(sp1+c2+sp2)).getText();
							System.out.println("Car Price Details :" + sCarPrice);
							JavascriptExecutor jse = (JavascriptExecutor)driver;
							jse.executeScript("window.scrollBy(0,100)", "");
							Thread.sleep(2000);
							}		
							String sCarDetails9 = driver.findElement(By.xpath(s1+9+s2)).getText();
							System.out.println("Car Details :" + sCarDetails9);			
						for (int c3 = 12; c3 < 16; c3++){			
							String sCarDetails = driver.findElement(By.xpath(s1+c3+s2)).getText();
							System.out.println("Car Details :" + sCarDetails);			
							String sCarPrice = driver.findElement(By.xpath(sp1+c3+sp2)).getText();
							System.out.println("Car Price Details :" + sCarPrice);
							JavascriptExecutor jse = (JavascriptExecutor)driver;
							jse.executeScript("window.scrollBy(0,100)", "");
							Thread.sleep(2000);
