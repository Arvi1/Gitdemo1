...
//	select PriceTo from the drop down list
		...
		//	System.out.println(option.getText());
			if(option.getText().contains("10,000"))
				option.click();					
		}				
		Thread.sleep(2000);
//	click Search Button
		...
		*/
		...
		String sCar1 = "//html/body/form/div[5]/div[2]/div[2]/div[2]/div[2]/div[2]/h2/a";
		String sCar2 = "//html/body/form/div[5]/div[2]/div[2]/div[2]/div[2]/div[3]/div[1]/h2/a";
		String sCar3 = "//html/body/form/div[5]/div[2]/div[2]/div[2]/div[2]/div[3]/div[2]/h2/a";
		String sCar4 = "//html/body/form/div[5]/div[2]/div[2]/div[2]/div[2]/div[3]/div[3]/h2/a";
		String sCar5 = "//html/body/form/div[5]/div[2]/div[2]/div[2]/div[2]/div[3]/div[4]/h2/a";
		try {
			System.out.println(driver.findElement(By.xpath(sCar1)).getText());
			System.out.println("Car1 is displayed");
		} catch (Exception e) {
			System.out.println(e.getMessage());
			}
		try {
			System.out.println(driver.findElement(By.xpath(sCar2)).getText());
			System.out.println("Car2 is displayed");
		} catch (Exception e1) {
			System.out.println(e1.getMessage());
			}	
		try {
			System.out.println(driver.findElement(By.xpath(sCar3)).getText());
			System.out.println("Car3 is displayed");
		} catch (Exception e2) {
			System.out.println(e2.getMessage());
			}
		try {
			System.out.println(driver.findElement(By.xpath(sCar4)).getText());
			System.out.println("Car4 is displayed");
		} catch (Exception e3) {
			System.out.println(e3.getMessage());
			}
		try {
			System.out.println(driver.findElement(By.xpath(sCar5)).getText());
			System.out.println("Car5 is displayed");			
		} catch (Exception e) {
			System.out.println(e.getMessage());
			}
	}	
